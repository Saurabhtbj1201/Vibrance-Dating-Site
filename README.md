<div align="center">
  <h1>💖 Vibrance</h1>
  <p>A modern dating application monorepo.</p>
  <b>⭐ If you find this project useful, please consider giving it a star! ⭐</b>
</div>

## 🚀 Overview

Vibrance is a full-stack dating application built using a modern TypeScript monorepo architecture. 
...
For more details on the project structure and architecture, please read through the codebase documentation.
